...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    <span class="navbar-brand mb-0 h1">Form Tambah Mahasiswa</span>
  </div>
</nav>
...
<br>
    <p>
        ...
        <table>
            ...
            <td >NRP</td>
            <td>
                <input type="text" name="nim" maxlength="14" autofocus>
            </td>
            </tr>
            ...
            <tr>
                <td>Tempat/Tanggal Lahir :</td>
                 <td>
                    <input type="text" name="tempat" size="30" > / <input type="date"
                    name="tanggal">
                </td>
            </tr>
